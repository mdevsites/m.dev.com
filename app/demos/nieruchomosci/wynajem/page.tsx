        ...
        <div className="min-h-screen bg-[#050505] flex flex-col items-center w-full relative overflow-hidden">
            ...
            <div className="max-w-[1280px] mx-auto w-full px-6 relative z-10">
                ...
                <div className="mb-8 text-center">
                    <h2 className="text-[#C5A059] text-sm md:text-xs uppercase tracking-[0.4em] mb-6 font-bold">Kolekcja Najmu</h2>
                    <h1 className="text-4xl md:text-7xl font-serif font-bold text-white mb-8">
                        Luksusowy <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70">Wynajem</span>
                    </h1>
                    <div className="flex justify-center w-full">
                        <p className="text-gray-400 max-w-[600px] text-lg leading-relaxed font-light text-center">
                            Znajdź swoją tymczasową rezydencję w najbardziej prestiżowych lokalizacjach.
                        </p>
                    </div>
                </div>
                                ...
                                <div className="flex flex-1">
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        ...
                                        <div className="mt-auto flex items-center justify-between">
                                            ...
                                            <Link
                                                href={`/demos/nieruchomosci/wynajem/${prop.id}`}
                ...
                {filteredProperties.length === 0 && (
                    <div className="py-24 text-center">
                        <h3 className="text-2xl font-serif text-gray-500 mb-6">Nie znaleźliśmy ofert najmu w tym momencie.</h3>
                        ...
                        >
                            Zobacz wszystkie oferty (Sprzedaż + Wynajem)
                        </button>
                    </div>
                )}
            </div>
